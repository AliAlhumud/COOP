...
if(isset($_POST['update2']))
{
    ...
    $query= " UPDATE table03 SET eid='$eid', ename='$ename', depaid='$depaid', depa= '$depa' WHERE eid='$eid'";
...
<form id="contact" name="add" method="POST" action="update.php" enctype="multipart/form-data">
        <div width="50">
...
<a href="https://www.alhasa.gov.sa/">
            ...
            <br>
                    <table border="2" align="center" width="500" height="400">
                        ...
                        <tr>
                                 <td>
                                <input class="x1" type="text" length= "30" name="ename" id="ename" value="<?php echo $info['ename']; ?>"/>
                            </td>
                            <th>
                         ...
                         <tr>
                                                         <td>
                                <input class="x1" type="text" readonly="readonly" name="depaid" id="depaid" value="<?php echo $info['depaid']; ?>"/>
                            </td>
                            <th>
