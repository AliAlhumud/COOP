                        ...
                        for(var i in out)
                            {
                                ...
                                list += "<td><form name='mdele' action='emod.php' method='post'><input type='checkbox' class='messageCheckbox' id='"+out[i].eid+"' name='deletex' style='float: right' value='"+out[i].eid+"'></form></td>";
